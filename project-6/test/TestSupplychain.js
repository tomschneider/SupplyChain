...
contract('SupplyChain', function(accounts) {
    ...
    const originFarmName = "yaya"
    const originFarmInformation = "booboo"
    const originFarmLatitude = "-66.239770"
    const originFarmLongitude = "99.341490"

    const productNotes = "Best booboo for Espresso"
    ...
    it("TEST DISTRIBUTOR: Item is Sold", async() => {
        {
            ...
            supplyChain.TomW_ADDED_RefundSent(null, (error, event) => {
                eventRefundSentEmitted = true;
            });

            var eventPaymentSentEmitted = false
            supplyChain.TomW_ADDED_PaymentSent(null, (error, event) => {
